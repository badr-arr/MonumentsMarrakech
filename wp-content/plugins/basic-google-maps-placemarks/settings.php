...
if( !class_exists( 'BGMPSettings' ) )
{
	...
	class BGMPSettings
	{
		...
		public function addSettingsPage()
		{
			...
			add_meta_box( BasicGoogleMapsPlacemarks::PREFIX . 'rasr-plug', __( 'Re-Abolish Slavery', 'basic-google-maps-placemarks' ), array( $this, 'markupRASRMetaBox' ), 'settings_page_' . BasicGoogleMapsPlacemarks::PREFIX .'settings', 'side' );
		}
		...
		{
			array_unshift( $links, '<a href="http://wordpress.org/extend/plugins/basic-google-maps-placemarks/faq/">'. __( 'Help', 'basic-google-maps-placemarks' ) .'</a>' );
			array_unshift( $links, '<a href="options-general.php?page='. BasicGoogleMapsPlacemarks::PREFIX . 'settings">'. __( 'Settings', 'basic-google-maps-placemarks' ) .'</a>' );
		...
		public function addSettings()
		{
			...
			// Map Settings
			add_settings_field( BasicGoogleMapsPlacemarks::PREFIX . 'map-width',				__( 'Map Width', 'basic-google-maps-placemarks' ),					array( $this, 'markupMapSettingsFields' ),	BasicGoogleMapsPlacemarks::PREFIX . 'settings', BasicGoogleMapsPlacemarks::PREFIX . 'map-settings',	 array( 'label_for' => BasicGoogleMapsPlacemarks::PREFIX . 'map-width' ) );
			add_settings_field( BasicGoogleMapsPlacemarks::PREFIX . 'map-height',				__( 'Map Height', 'basic-google-maps-placemarks' ),					array( $this, 'markupMapSettingsFields' ),	BasicGoogleMapsPlacemarks::PREFIX . 'settings', BasicGoogleMapsPlacemarks::PREFIX . 'map-settings',	 array( 'label_for' => BasicGoogleMapsPlacemarks::PREFIX . 'map-height' ) );
			add_settings_field( BasicGoogleMapsPlacemarks::PREFIX . 'map-address',				__( 'Map Center Address', 'basic-google-maps-placemarks' ),			array( $this, 'markupMapSettingsFields' ),	BasicGoogleMapsPlacemarks::PREFIX . 'settings', BasicGoogleMapsPlacemarks::PREFIX . 'map-settings',	 array( 'label_for' => BasicGoogleMapsPlacemarks::PREFIX . 'map-address' ) );
			add_settings_field( BasicGoogleMapsPlacemarks::PREFIX . 'map-zoom',					__( 'Zoom', 'basic-google-maps-placemarks' ),						array( $this, 'markupMapSettingsFields' ),	BasicGoogleMapsPlacemarks::PREFIX . 'settings', BasicGoogleMapsPlacemarks::PREFIX . 'map-settings',	 array( 'label_for' => BasicGoogleMapsPlacemarks::PREFIX . 'map-zoom' ) );
			add_settings_field( BasicGoogleMapsPlacemarks::PREFIX . 'map-type',					__( 'Map Type', 'basic-google-maps-placemarks' ),					array( $this, 'markupMapSettingsFields' ),	BasicGoogleMapsPlacemarks::PREFIX . 'settings', BasicGoogleMapsPlacemarks::PREFIX . 'map-settings',	 array( 'label_for' => BasicGoogleMapsPlacemarks::PREFIX . 'map-type' ) );
			add_settings_field( BasicGoogleMapsPlacemarks::PREFIX . 'map-type-control',			__( 'Type Control', 'basic-google-maps-placemarks' ),				array( $this, 'markupMapSettingsFields' ),	BasicGoogleMapsPlacemarks::PREFIX . 'settings', BasicGoogleMapsPlacemarks::PREFIX . 'map-settings',	 array( 'label_for' => BasicGoogleMapsPlacemarks::PREFIX . 'map-type-control' ) );
			add_settings_field( BasicGoogleMapsPlacemarks::PREFIX . 'map-navigation-control',	__( 'Navigation Control', 'basic-google-maps-placemarks' ),			array( $this, 'markupMapSettingsFields' ),	BasicGoogleMapsPlacemarks::PREFIX . 'settings', BasicGoogleMapsPlacemarks::PREFIX . 'map-settings',	 array( 'label_for' => BasicGoogleMapsPlacemarks::PREFIX . 'map-navigation-control' ) );
			add_settings_field( BasicGoogleMapsPlacemarks::PREFIX . 'map-info-window-width',	__( 'Info. Window Maximum Width', 'basic-google-maps-placemarks' ),	array( $this, 'markupMapSettingsFields' ),	BasicGoogleMapsPlacemarks::PREFIX . 'settings', BasicGoogleMapsPlacemarks::PREFIX . 'map-settings',	 array( 'label_for' => BasicGoogleMapsPlacemarks::PREFIX . 'map-info-window-width' ) );
			...
			// Marker Clustering
			add_settings_field( BasicGoogleMapsPlacemarks::PREFIX . 'marker-clustering',	__( 'Marker Clustering', 'basic-google-maps-placemarks' ),	array( $this, 'markupMarkerClusterFields' ),	BasicGoogleMapsPlacemarks::PREFIX . 'settings', BasicGoogleMapsPlacemarks::PREFIX . 'marker-cluster-settings',	 array( 'label_for' => BasicGoogleMapsPlacemarks::PREFIX . 'marker-clustering' ) );
			add_settings_field( BasicGoogleMapsPlacemarks::PREFIX . 'cluster-max-zoom',		__( 'Max Zoom', 'basic-google-maps-placemarks' ),			array( $this, 'markupMarkerClusterFields' ),	BasicGoogleMapsPlacemarks::PREFIX . 'settings', BasicGoogleMapsPlacemarks::PREFIX . 'marker-cluster-settings',	 array( 'label_for' => BasicGoogleMapsPlacemarks::PREFIX . 'cluster-max-zoom' ) );
			add_settings_field( BasicGoogleMapsPlacemarks::PREFIX . 'cluster-grid-size',	__( 'Grid Size', 'basic-google-maps-placemarks' ),			array( $this, 'markupMarkerClusterFields' ),	BasicGoogleMapsPlacemarks::PREFIX . 'settings', BasicGoogleMapsPlacemarks::PREFIX . 'marker-cluster-settings',	 array( 'label_for' => BasicGoogleMapsPlacemarks::PREFIX . 'cluster-grid-size' ) );
			add_settings_field( BasicGoogleMapsPlacemarks::PREFIX . 'cluster-style',		__( 'Style', 'basic-google-maps-placemarks' ),				array( $this, 'markupMarkerClusterFields' ),	BasicGoogleMapsPlacemarks::PREFIX . 'settings', BasicGoogleMapsPlacemarks::PREFIX . 'marker-cluster-settings',	 array( 'label_for' => BasicGoogleMapsPlacemarks::PREFIX . 'cluster-style' ) );
