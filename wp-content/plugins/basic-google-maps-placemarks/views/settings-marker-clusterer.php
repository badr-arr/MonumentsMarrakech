...
<?php elseif( $field[ 'label_for' ] == BasicGoogleMapsPlacemarks::PREFIX . 'cluster-style' ) : ?>
	...
	<select id="<?php esc_attr_e( BasicGoogleMapsPlacemarks::PREFIX ); ?>cluster-style" name="<?php esc_attr_e( BasicGoogleMapsPlacemarks::PREFIX ); ?>cluster-style">
		<option value="default" <?php echo selected( $this->clusterStyle, 'default', false ); ?>><?php esc_html_e( 'Default', 'basic-google-maps-placemarks' ); ?></option>
		<option value="people" <?php echo selected( $this->clusterStyle, 'people', false ); ?>><?php esc_html_e( 'People', 'basic-google-maps-placemarks' ); ?></option>
		<option value="hearts" <?php echo selected( $this->clusterStyle, 'hearts', false ); ?>><?php esc_html_e( 'Hearts', 'basic-google-maps-placemarks' ); ?></option>
		<option value="conversation" <?php echo selected( $this->clusterStyle, 'conversation', false ); ?>><?php esc_html_e( 'Conversation', 'basic-google-maps-placemarks' ); ?></option>
	</select>
